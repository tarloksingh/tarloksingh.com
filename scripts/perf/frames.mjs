...
const [, , which = 'phone', cpuArg = '4'] = process.argv
...
await cdp.send('Page.navigate', { url: `http://127.0.0.1:${process.env.PERF_PORT || 8100}/` })
await wait(9000)
...
console.log(`\n=== / ${which} cpu ${cpuArg}x — ripple ${rip}→${gone}ms over ${P.cells} cells, cover lifts ${cover}ms ===`)
