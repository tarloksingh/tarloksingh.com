...
// Ported from ReactBits' OptionWheel (reactbits.dev/components/option-wheel),
...
export interface OptionWheelProps {
  ...
  className?: string
  /**
   * Element that should capture scroll for the wheel. Defaults to the wheel
   * itself; pass a larger container to make a whole section scrollable.
   */
...
export default function OptionWheel({
  ...
  useEffect(() => {
    const el = scrollTarget ? scrollTarget.current : rootRef.current
    if (!el) return
